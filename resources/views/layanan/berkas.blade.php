...
<script>
    ...
    $('.btn-add').on('click', function() {
        $.ajax({
            method: 'GET',
            url: `{{ url('layanan/berkasTa/create')}}`,
    ...
    function store() {
        $('#formAction').on('submit', function(e) {
            ...
            $.ajax({
                ...
                contentType: false,
                success: function(res) {
                    window.LaravelDataTables["berkasta-table"].ajax.reload()
                    modal.hide()
                },
                error: function(res) {
    ...
    $('#berkasta-table').on('click', '.action', function() {
        let data = $(this).data()
        let id = data.id
        ...
        $.ajax({
            method: 'get',
            url: `{{ url('layanan/berkasTa/')}}/${id}/edit`,
            success: function(res) {
                $('#modalAction').find('.modal-dialog').html(res)
                modal.show()
                store()
