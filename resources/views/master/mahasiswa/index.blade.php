            ...
            <div class="row same-height">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (request()->user()->can('create master/mahasiswa'))
...
@push('js')
    ...
    <script>
        ...
        $('.btn-add').on('click', function() {
            $.ajax({
                method: 'GET',
                url: `{{ url('master/mahasiswa/create') }}`,
        ...
        $('#mahasiswa-table').on('click', '.action', function() {
            let data = $(this).data()
            let id = data.id
            ...
            $.ajax({
                method: 'get',
                url: `{{ url('master/mahasiswa/') }}/${id}/edit`,
                success: function(res) {
                    $('#modalAction').find('.modal-dialog').html(res)
                    modal.show()
                    store()
